...
const LEVELS = [
  ...
  },
  {
    ...
    levelSelectTitle: "Level 6 - Full Network",
    difficulty: "Hard",
    benchmark: "$400",
    demand: "13 riders",
    routeLimit: "70 min",
    ...
    edgePickups: "7 road pickups",
    progressStars: 3,
    description: "The full prototype-scale network combines long corridors, dense clusters, and multiple reasonable fleet mixes",
    levelSelectDescription:
      "The full prototype-scale network combines long corridors, dense clusters, and multiple reasonable fleet mixes.",
    ...
    objectives: [
      "Serve all 13 riders across the full graph",
      "Balance bus capacity, route structure, and multi-trip duty usage",
      "Beat the $400 benchmark with a complete system-level plan",
    ],
    stats: {
      selectedBus: "Coach 01",
      routeTime: "0 / 60 min",
      dutyTime: "58 / 60 min",
      load: "0 / 20",
      totalCost: "$320 / $400",
    ...
    results: {
      ...
      starsEarned: 3,
      summary:
        "This one-coach schedule clears the full network under budget and now defines the current optimal replay target",
      highlights: [
        "All road demand cleared across the largest scenario.",
        "One coach handles the work in three connected trips.",
        "The built-in optimal replay now mirrors your latest submitted Level 6 solution.",
      ],
    },
  },
];
    ...
    buses: [
      {
        ...
        completedRouteHistory: [
          {
            routeNodeLabels: ["factory", "2", "59", "51", "54", "1", "5", "61"],
            startMinute: 0,
            durationMinutes: 17,
            pickupPlan: {
              2: 3,
          ...
          {
            routeNodeLabels: ["61", "62", "63", "41", "56", "2", "factory"],
            startMinute: 17,
            durationMinutes: 14,
            pickupPlan: {
              2: 2,
          ...
          {
            routeNodeLabels: ["factory", "2", "47", "57", "4", "10", "58", "9", "43", "55", "41", "60"],
            startMinute: 31,
            durationMinutes: 27,
            pickupPlan: {
              3: 1,
...
const FOUNDRY_SAVED_EDIT_LAYOUT_FALLBACKS = {
  ...
  "Level 6 - Full Network": {
    ...
    nodes: [
      ...
      { label: "58", variant: "blue", left: 79.4, top: 48.6, demand: 1 },
      { label: "59", variant: "blue", left: 38.6, top: 37.5, demand: 3 },
      { label: "60", variant: "depot", left: 70.1, top: 58.9, demand: 0 },
      { label: "61", variant: "depot", left: 30.5, top: 69.8, demand: 0 },
      { label: "62", variant: "brown", left: 35.6, top: 60.9, demand: 0 },
      { label: "63", variant: "blue", left: 46.6, top: 57.3, demand: 2 },
    ],
    assets: [],
    roads: [
      { from: "1", to: "2" },
